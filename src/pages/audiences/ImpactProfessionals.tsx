    ...
    <section className="relative min-h-[70vh] flex items-center overflow-hidden bg-gradient-to-br from-warm-900 via-warm-800 to-seam-900">
      ...
      <div className="absolute inset-0">
        <img
          ...
          alt="Social impact professionals in the built environment"
      ...
      <div className="relative mx-auto max-w-[1400px] px-6 lg:px-10 py-24 lg:py-32 w-full">
        <div className="hero-enter max-w-4xl mx-auto text-center">
          ...
          <div className="hero-cta mt-10 flex flex-wrap gap-4 justify-center">
            ...
            <Link to="/community" className="inline-flex items-center rounded-full border border-white/25 px-8 py-4 text-[16px] font-medium text-white hover:border-white/50 transition-colors duration-300">
              Join the community
            </Link>
          </div>
        </div>
...
const challenges = [
  ...
  },
  {
    ...
    solution: 'The community connects you with a practitioner network of APs, certified project teams, and organizations committed to the Standard. Peer learning, templates, and co-practice opportunities.',
  },
  {
...
const products = [
  { label: 'AP Credential', title: 'Your professional qualification', description: 'The SEAM AP demonstrates mastery of the Standard. Clients and employers recognize it as evidence of deep social equity expertise in the built environment.', href: '/ap-credential', fit: 'Best for consultants, DEI practitioners, and sustainability professionals building a practice.', logo: '/logos/ap-seal.png' },
  { label: 'Community', title: 'Your practitioner network', description: 'Membership community with templates, peer connection, course access, ROSSI tools, and co-practice opportunities with other APs and certified project teams.', href: '/community', fit: 'Best for ongoing support, learning, and professional development after earning the AP.', logo: '/logos/member-individual.png' },
...
function Backgrounds() {
  ...
  return (
    <section className="py-24 lg:py-32">
      <div className="mx-auto max-w-[1400px] px-6 lg:px-10">
        <div ref={headerRef} className="reveal-slide-left max-w-2xl mb-16 lg:mb-20">
          <p className="text-[13px] font-medium uppercase tracking-[0.15em] text-gold-500 mb-6">Your background</p>
          <h2 className="font-display text-[clamp(2rem,4vw,3.5rem)] leading-[1.1] tracking-[-0.03em] text-warm-900">
...
const faqs = [
  ...
  { q: 'How do I find project opportunities after earning the AP?', a: 'APs are listed in the SEAM directory, which project teams use to find qualified practitioners. Community membership provides additional networking, co-practice opportunities, and referral access.' },
  ...
  { q: 'Is there a community of other practitioners?', a: 'Yes. The community is the membership hub for APs and organizations. It includes peer learning, templates, ROSSI access, continuing education opportunities, and networking with certified project teams.' },
]
