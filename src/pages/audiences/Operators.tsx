      ...
      <div className="relative mx-auto max-w-[1400px] px-6 lg:px-10 py-24 lg:py-32 w-full">
        <div className="hero-enter max-w-3xl">
          ...
          <h1 className="hero-title font-display text-[clamp(2.5rem,5vw,4.5rem)] leading-[1.05] tracking-[-0.04em] text-white">
            ...
            <em className="font-display italic font-normal text-seam-300">a verified credential</em>
          </h1>
...
const products = [
  { label: 'SEAM Approved', title: 'Start with what you have', description: 'Verify individual practices — local hiring, community programs, accessibility improvements — without full certification commitment.', href: '/approved', fit: 'Best for teams wanting quick wins and visible proof of existing equity work.' },
  { label: 'Certification', title: 'Operations + Maintenance track', description: 'Full certification for existing buildings based on how they operate — procurement, programming, staffing, and community engagement.', href: '/certification', fit: 'Best for buildings ready to demonstrate comprehensive social equity performance.' },
  { label: 'Commons', title: 'Membership community', description: 'Templates, peer learning, ROSSI access, and ongoing support for teams implementing the Standard across their portfolio.', href: '/commons', fit: 'Best for teams managing multiple properties or pursuing certification at scale.' },
]
...
const faqs = [
  ...
  { q: 'Can we verify practices across multiple properties?', a: 'Yes. Commons membership includes portfolio tools for rolling out SEAM Approved across multiple properties. Volume pricing is available for organizations verifying the same activity across a portfolio.' },
