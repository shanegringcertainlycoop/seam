...
const products = [
  ...
  { label: 'Certification', title: 'Portfolio-level diligence', description: 'Require or incentivize SEAM certification across portfolio assets. Standardized social performance data flows into ESG reports without manual reconciliation.', href: '/certification', fit: 'Best for institutional owners setting social performance requirements across holdings.' },
