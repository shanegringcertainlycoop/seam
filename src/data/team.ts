...
export const team: TeamMember[] = [
  ...
  },
  {
    ...
    image: '/images/team/alex-demestihas.jpeg',
  },
  {
    slug: 'chris-pirschel',
    name: 'Chris Pirschel',
    role: 'Chief Marketing Officer',
    bio: 'Chris builds the brands behind certifications. As Chief Marketing Officer at SEAM, he leads marketing, communications, and growth — driving awareness and adoption of SEAM Certification\u2122 and the SEAM AP credential worldwide. He helps mission-driven organizations sharpen their voice, grow their audiences, and turn complex standards into clear, compelling stories. His experience spans more than a decade in the certification and membership space, including roles with the International WELL Building Institute and the Oncology Nursing Society.',
  ...
  },
  {
    ...
    bio: 'Shane builds the operations behind certifications. As Chief Operating Officer at SEAM, he leads the systems, infrastructure, and execution that turn the SEAM Standard into a scalable global program. He helps mission-driven organizations translate ambitious standards into the operational backbone that makes them real — from credentialing workflows to partner ecosystems. His experience spans more than a decade in the certification and membership space, including roles with the U.S. Green Building Council and the International WELL Building Institute.',
    image: '/images/team/shane-gring.jpg',
  },
  {
    slug: 'terena-campagna',
  ...
  },
  {
    ...
    name: 'Bruce Thomson',
    role: 'Board Member',
    bio: 'Global lead at S&P Global Ratings for integrating social factors, risks, and insights into sustainable finance analyses, credit ratings, and research, with prior experience advising the world\'s most recognizable brands on social performance and supply chain strategy and partnering with asset managers overseeing $150B+ AuM on ESG due diligence and investment stewardship.',
    image: '/images/team/bruce-thomson.jpeg',
  },
]
