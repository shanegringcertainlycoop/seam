...
export const seamAPs: SeamAP[] = [
  ...
  },
  {
    ...
    name: 'Curtis Stewart',
    photo: '',
    title: 'Social Sustainability Consultant',
    organization: 'UL',
    location: { city: '', state: '' },
  ...
  },
  {
    ...
    photo: '',
    title: '',
    organization: 'Swinerton Construction',
    location: { city: 'Atlanta', state: 'GA' },
    specialties: ['Procurement', 'Workforce'],
    bio: '',
    credentials: 'Member',
